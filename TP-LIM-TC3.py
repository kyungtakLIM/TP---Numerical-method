...
plt.ylabel("y [cm]");
plt.grid()
plt.savefig("V_xy_%g_TC3.png" %N_iteration);
plt.show();
...
plt.ylabel("V [V]");
plt.grid()
plt.savefig("V_x_%g_TC3.png" %N_iteration);
plt.show();
plt.clf();
...
plt.savefig("Ex_field_%g_TC3.png" %N_iteration);
plt.show();
...
plt.savefig("Ey_field_%g_TC3.png" %N_iteration);
plt.show();
